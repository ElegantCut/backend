...
export class UploadsController {
  ...
  @ApiOperation({
    ...
    description:
      'Permite subir una imagen (avatar, foto de portafolio) al bucket de Cloudinary. Retorna la URL segura y el ID público.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Devuelve la URL pública y segura de una imagen previamente subida usando su ID.',
  })
  @ApiParam({
    name: 'id',
