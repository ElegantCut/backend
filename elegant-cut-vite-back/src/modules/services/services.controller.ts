...
export class ServicesController {
  ...
  @ApiOperation({
    ...
    description:
      'Devuelve la lista con el formato específico que requiere la tabla del Dashboard.',
  })
  @Get('admin/all')
  async getAllAdmin() {
  ...
  @ApiOperation({
    ...
    description:
      'Devuelve la lista de categorías con su género para el formulario de nuevo servicio.',
  })
  @Get('categories')
  async getCategories() {
  ...
  @ApiOperation({
    ...
    description:
      'Devuelve la lista completa de los servicios de barbería ofrecidos.',
  })
  @ApiResponse({
    status: 200,
