...
var prisma_module_1 = require("../../prisma/prisma.module"); // Asegúrate de que la ruta suba los niveles necesarios
var UsersModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [prisma_module_1.PrismaModule], // <-- Esto es lo que permite que el service use Prisma
            controllers: [users_controller_1.UsersController, clients_controller_1.ClientsController, admin_controller_1.AdminController],
