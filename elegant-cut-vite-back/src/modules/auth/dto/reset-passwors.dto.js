...
var ResetPasswordDto = function () {
    ...
    return _a = /** @class */ (function () {
            function ResetPasswordDto() {
                this.email = __runInitializers(this, _email_initializers, void 0); // El correo al que se envió el código
                this.codigo = (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _codigo_initializers, void 0)); // El código de 6 dígitos que recibió por correo
                this.newPassword = (__runInitializers(this, _codigo_extraInitializers), __runInitializers(this, _newPassword_initializers, void 0)); // La nueva contraseña que quiere crear
        ...
        (function () {
            ...
            _codigo_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.Length)(6, 6)];
            _newPassword_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.Length)(8, 20)];
