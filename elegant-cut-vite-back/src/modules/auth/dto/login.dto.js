...
var LoginDto = function () {
    ...
    return _a = /** @class */ (function () {
            function LoginDto() {
                this.username = __runInitializers(this, _username_initializers, void 0); // Coincide con "Ingrese su nombre de usuario"
                this.contrasena = (__runInitializers(this, _username_extraInitializers), __runInitializers(this, _contrasena_initializers, void 0)); // Coincide con "Ingrese su contraseña"
        ...
        (function () {
            ...
            _username_decorators = [(0, swagger_1.ApiProperty)({
                ...
                }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)({ message: 'El nombre de usuario es requerido' })];
            _contrasena_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'La contraseña de la cuenta',
                    example: 'MiPasswordSeguro123',
                }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)({ message: 'La contraseña es requerida' })];
