...
export class NotificationsController {
  ...
  @Post('n8n')
  async createNotificationFromN8N(@Body() body: { id_usuario: number; titulo: string; mensaje: string }) {
    return this.notificationsService.createNotification(body.id_usuario, body.titulo, body.mensaje);
  }
}
