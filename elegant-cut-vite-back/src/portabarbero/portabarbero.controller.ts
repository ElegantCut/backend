...
export class PortabarberoController {
    ...
    @ApiOperation({ summary: 'Crear perfil/portafolio de un barbero', description: 'Registra los datos profesionales (biografía, experiencia, Instagram, fotos) de un barbero activo.' })
    ...
    @ApiOperation({ summary: 'Obtener portafolio de un barbero', description: 'Devuelve toda la información pública del portafolio de un barbero dado su ID de usuario.' })
